...
$kategori_id = 4; // Telefon için kategori_id 4
...
if (!$miktar) {
    ...
    <div class='container'>
        <div class='alert'>
            <h1>📱 Telefon Faturası Bulunamadı!</h1>
            <p>Şu anda ödenecek bir Telefon faturanız bulunmamaktadır.</p>
...
<head>
    ...
    <title>Telefon Faturası Öde</title>
    <style>
        body {
