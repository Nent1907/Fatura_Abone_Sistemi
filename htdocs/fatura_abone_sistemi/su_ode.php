...
$kategori_id = 2; // Su için kategori_id 2
...
if (!$miktar) {
    ...
    <div class='container'>
        <div class='alert'>
            <h1>🚰 Su Faturası Bulunamadı!</h1>
            <p>Şu anda ödenecek bir su faturanız bulunmamaktadır.</p>
            <p>Başka işlemler yapmak isterseniz, <a href='main_page.php'>ana sayfaya</a> dönebilirsiniz.</p>
        </div>
    </div>";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($bakiye >= $miktar) {
        ...
        try {
            ...
            <div class='container'>
                <div class='success'>
                    ...
                    <p>Su faturanız başarıyla ödendi. Ana sayfaya yönlendiriliyorsunuz...</p>
                </div>
            </div>";
            ...
            <div class='container'>
                <div class='alert'>
                    <h1>⚠️ Hata Oluştu!</h1>
                    <p>Ödeme sırasında bir hata meydana geldi: " . $e->getMessage() . "</p>
                </div>
            </div>";
        }
    } else {
        ...
        <div class='container'>
            <div class='alert'>
                <h1>⚠️ Yetersiz Bakiye!</h1>
                <p>Su faturasını ödemek için bakiyeniz yetersiz. Ana sayfaya dönüyorsunuz...</p>
            </div>
        </div>";
        header("Refresh: 3; url=main_page.php");
    }
