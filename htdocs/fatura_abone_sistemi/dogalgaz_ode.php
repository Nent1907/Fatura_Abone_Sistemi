...
$kategori_id = 3; // Doğalgaz için kategori_id 3
...
if (!$miktar) {
    ...
    <div class='container'>
        <div class='alert'>
            <h1>🔥 Doğalgaz Faturası Bulunamadı!</h1>
            <p>Şu anda ödenecek bir Doğalgaz faturanız bulunmamaktadır.</p>
...
<head>
    ...
    <title>Doğalgaz Faturası Öde</title>
    <style>
        body {
